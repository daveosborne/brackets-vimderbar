...
(function(mod) {
  ...
  else // Plain browser env*/ // Removed for @ff.
    mod(brackets.getModule("thirdparty/CodeMirror2/lib/codemirror")); // added for @ff
})(function(CodeMirror) {
  'use strict';
  ...
  var Vim = function() {
    ...
    function dialog(cm, template, shortText, onClose, options) {
      ...
      if (CodeMirror.openVimDialog) {
        CodeMirror.openVimDialog(template, shortText, onClose, { bottom: true, value: options }, cm); //added by @ff
      } else {
