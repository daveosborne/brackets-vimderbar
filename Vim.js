...
/*jslint vars: true, plusplus: true, devel: true, nomen: true, indent: 2, maxerr: 200, continue: true*/
/*global define, brackets, $, Mustache, CodeMirror */
(function() {
  'use strict';
  ...
  var Vim = function() {
    ...
    function dialog(cm, text, shortText, callback, initialValue) {
      if (CodeMirror.openVimDialog) {
        CodeMirror.openVimDialog(text, callback, { bottom: true, value: initialValue }, cm);
    ...
    function makePrompt(prefix, desc) {
      return { commandSign: prefix, commandInfo: desc };
    }
    ...
    function findNext(cm, prev, repeat) {
      if (CodeMirror.processVimSearch) { 
        CodeMirror.processVimSearch(prev);
        return;
      }
    ...
    var exCommands = {
      ...
      write: function(cm) {
        if (CodeMirror.commands.vimSave) {
          // If a save command is defined, call it. (modified by @ff)
